...
const DUTY_SELECT = 'id, name, notes, schedule_key_id, display_order, start_time, end_time, second_day, parent_duty_id, duty_types(name), duty_trains(train_id, sequence_order, trains(departure_time))';
